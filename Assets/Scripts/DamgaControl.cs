...
public class DamgaControl : MonoBehaviour
{
    ...
    void DamgaBasmaFunction()
    {
        ...
        transform.DOMove(new Vector3(transform.position.x - 1f, transform.position.y - 2.5f, transform.position.z), damgaSpeed / 1.5f).OnComplete(() => transform.DOMove(firstPositionDamga, damgaSpeed / 1.5f)); // Damgan�n bas�laca�� yer kodu
